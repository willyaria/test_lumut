		...
		<div class="card">
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" placeholder="Name" name="name" id="name" value="<?= $dt->name ?>" autocomplete="off">				
						<input type="hidden" class="form-control" name="id" id="id" value="<?= $dt->id ?>" autocomplete="off">				
					</div>
				</div>		
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" id="username" name="username" value="<?= $dt->username ?>" placeholder="Username" autocomplete="off">							
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="password" class="form-control" id="password" name="password" value="<?= $dt->password ?>" placeholder="Password">							
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" id="role" name="role" value="<?= $dt->role ?>" placeholder="Role" autocomplete="off" onkeypress="return angkadanhuruf(event,'+0123456789',this)">							
					</div>
				</div>
